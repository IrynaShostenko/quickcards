import { cardEditorRowText } from "../../constants/uiText";
  ...
  return (
    <article className="grid grid-cols-[1fr_1fr_1.3fr_0.9fr_52px] gap-4 px-6 py-5">
      <input
        ...
        placeholder={cardEditorRowText.placeholders.front}
      />
      ...
      <input
        ...
        className="rounded-2xl bg-slate-50 px-4 py-3 outline-none focus:ring-2 focus:ring-indigo-200"
        placeholder={cardEditorRowText.placeholders.back}
      />
      ...
      <input
        ...
        className="rounded-2xl bg-slate-50 px-4 py-3 outline-none focus:ring-2 focus:ring-indigo-200"
        placeholder={cardEditorRowText.placeholders.example}
      />
      ...
      <input
        ...
        placeholder={cardEditorRowText.placeholders.note}
      />
      ...
      <button
        ...
        aria-label={cardEditorRowText.deleteAriaLabel}
      >
        ×
      </button>
    </article>
